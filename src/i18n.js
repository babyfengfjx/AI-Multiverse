...
const I18N = {
  en: {
    ...
    close_all_desc:
      "This will close all browser windows currently opened by AI Multiverse.",
    close_all_warning:
      "Are you sure you want to close all AI conversation windows? In-progress responses will not be saved.",
    cancel: "Cancel",
    ...
    select_summary_model: "Select AI model for summarization",
  ...
  "zh-CN": {
    ...
    close_all_warning:
      "确定要一键关闭所有 AI 对话窗口吗？正在运行的回答不会被保存。",
    cancel: "取消",
    confirm_close: "确定",
    ...
    // New tooltip keys
    jump_to_summary: "直达智能总结",
    select_summary_model: "选择总结用 AI 模型",
